  ...
  return (
    <header className="sticky top-0 z-20 border-b border-border-subtle bg-background/80 backdrop-blur-md">
      <div className="flex h-16 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <SidebarTrigger className="text-text-secondary hover:bg-surface-3 hover:text-foreground transition-colors" />
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="ghost"
            size="icon"
            className="text-text-secondary hover:bg-surface-3 hover:text-foreground"
          >
